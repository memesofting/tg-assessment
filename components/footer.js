        ...
        <footer className="flex flex-col">
            ...
            <section className="grid grid-cols-4 gap-3">
                <div>
                    ...
                    <div className="flex flex-row">
                        <Image src="/images/ri_linkedin-fill.svg" width={40} height={40} alt="linkedin logo" />
                        <Image src="/images/ri_instagram-fill.svg" width={40} height={40} alt="linkedin logo" />
                        <Image src="/images/line-md_twitter-x.svg" width={40} height={40} alt="linkedin logo" />
                    </div>
                </div>
                <div>
                    <h4>What We Do</h4>
            ...
            <section>
                <div>
                    ...
                    <div>
                        <p>United Kingdom</p>
                        <p>07451196 (Registered by Company House)
                            Vine Cottages, 215 North Street, Romford, Essex,
                            United Kingdom, RM1 4QA
                        </p>
                    </div>
                    <div>
                        <p>Nigeria</p>
                        <p>RC 1048722 (Registered by the Corporate Affairs Commission)
                ...
                <div>
                    ...
                    <div>
                        <Image src="/images/material-symbols_mail.svg" width={24} height={24} alt="" />
